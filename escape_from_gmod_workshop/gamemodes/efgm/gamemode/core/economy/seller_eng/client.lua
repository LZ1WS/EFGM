...
net.Start("Sell_ENG m3super RUB")
net.SendToServer()
end
...
net.Start("Sell_ENG m3super DOL")
net.SendToServer()
end
...
panel1.Paint = function(self, w, h)		// Paint function w, h = how wide and tall it is
	draw.RoundedBox(2, 0, 0, w, h, faded_black)	// Draws a rounded box with the color faded_black stored abouve
	draw.SimpleText("Макаров| 160 RUB", "Text", 5, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Макаров| 50 USD", "Text", 5, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AK-74| 1250 RUB", "Text", 285, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AK-74| 660 USD", "Text", 285, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("VSS| 2580 RUB", "Text", 545, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("VSS| 1000 USD", "Text", 545, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AR-15| 1450 RUB", "Text", 785, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AR-15| 700 USD", "Text", 785, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Fiveseven| 315 RUB", "Text", 1045, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Fiveseven| 115 USD", "Text", 1045, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("L85A2| 1580 RUB", "Text", 5, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("L85A2| 750 USD", "Text", 5, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M14 EBR| 3080 RUB", "Text", 300, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M14 EBR| 1115 USD", "Text", 300, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M1911| 280 RUB", "Text", 545, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M1911| 90 USD", "Text", 545, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M249| 3830 RUB", "Text", 785, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M249| 1410 USD", "Text", 785, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M3 Super| 910 RUB", "Text", 1045, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M3 Super| 400 USD", "Text", 1045, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MAC-10| 400 RUB", "Text", 5, 620, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MAC-10| 180 USD", "Text", 5, 660, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
return true
end
panel2.Paint = function(self, w, h)		// Paint function w, h = how wide and tall it is
	draw.RoundedBox(2, 0, 0, w, h, faded_black)	// Draws a rounded box with the color faded_black stored abouve
	draw.SimpleText("G3A3| 2580 RUB", "Text", 5, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("G3A3| 915 USD", "Text", 5, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("G36| 1780 RUB", "Text", 285, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("G36| 830 USD", "Text", 285, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("UMP| 915 RUB", "Text", 545, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("UMP| 400 USD", "Text", 545, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MP5| 750 RUB", "Text", 785, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MP5| 200 USD", "Text", 785, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("SCAR-H| 2650 RUB", "Text", 1050, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("SCAR-H| 1000 USD", "Text", 1050, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("DEAGLE| 550 RUB", "Text", 1045, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("DEAGLE| 230 USD", "Text", 1045, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("L115| 3330 RUB", "Text", 785, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("L115| 1410 USD", "Text", 785, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MR96| 750 RUB", "Text", 5, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MR96| 280 USD", "Text", 5, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("P99| 200 RUB", "Text", 285, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("P99| 60 USD", "Text", 285, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Shorty| 450   RUB", "Text", 545, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Shorty| 190   USD", "Text", 545, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
return true
end end

concommand.Add("sell_open_eng", OpenSellENG)