...
net.Start("Buy_ENG flaregun RUB")
net.SendToServer()
end
...
net.Start("Buy_ENG flaregun DOL")
net.SendToServer()
end
...
panel1.Paint = function(self, w, h)		// Paint function w, h = how wide and tall it is
	...
	draw.SimpleText("Макаров| 500 RUB", "Text", 5, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Макаров| 175 USD", "Text", 5, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AK-74| 3750 RUB", "Text", 285, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AK-74| 2000 USD", "Text", 285, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("VSS| 7750 RUB", "Text", 545, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("VSS| 3000 USD", "Text", 545, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AR-15| 4350 RUB", "Text", 785, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("AR-15| 2100 USD", "Text", 785, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Fiveseven| 950 RUB", "Text", 1045, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Fiveseven| 350 USD", "Text", 1045, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("L85A2| 4750 RUB", "Text", 5, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("L85A2| 2250 USD", "Text", 5, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M14 EBR| 9250 RUB", "Text", 300, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M14 EBR| 3350 USD", "Text", 300, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M1911| 850 RUB", "Text", 545, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M1911| 275 USD", "Text", 545, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M249| 11500 RUB", "Text", 785, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M249| 4250 USD", "Text", 785, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M3 Super| 2750 RUB", "Text", 1045, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("M3 Super| 1225 USD", "Text", 1045, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MAC-10| 1250 RUB", "Text", 5, 620, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MAC-10| 550 USD", "Text", 5, 660, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
return true
end
panel2.Paint = function(self, w, h)		// Paint function w, h = how wide and tall it is
	draw.RoundedBox(2, 0, 0, w, h, faded_black)	// Draws a rounded box with the color faded_black stored abouve
	draw.SimpleText("G3A3| 7750 RUB", "Text", 5, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("G3A3| 2750 USD", "Text", 5, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("G36| 5350 RUB", "Text", 285, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("G36| 2500 USD", "Text", 285, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("UMP| 2750 RUB", "Text", 545, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("UMP| 1225 USD", "Text", 545, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MP5| 2250 RUB", "Text", 785, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MP5| 900 USD", "Text", 785, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("SCAR-H| 8000 RUB", "Text", 1050, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("SCAR-H| 3000 USD", "Text", 1050, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("DEAGLE| 1650 RUB", "Text", 1045, 420, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("DEAGLE| 700 USD", "Text", 1045, 460, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	...
	draw.SimpleText("MR96| 2250 RUB", "Text", 5, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("MR96| 850 USD", "Text", 5, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("P99| 600 RUB", "Text", 285, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("P99| 200 USD", "Text", 285, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Shorty| 1350   RUB", "Text", 545, 180, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Shorty| 575   USD", "Text", 545, 214, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Flare Gun| 10000 RUB", "Text", 5, 620, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
	draw.SimpleText("Flare Gun| 4800 USD", "Text", 5, 660, Color( 0, 204, 0, 255 ), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP)
return true
end end

concommand.Add("shop_open_eng", OpenTraderShopENG)